    ...
    return (
        <Box sx={{ display: 'flex', marginBottom: 15 }}>
            ...
            >
                ...
                <Divider />
                <List>
                    {['Home', 'Characters', 'Locations', 'Episodes'].map((text, index) => (
                        <ListItem key={text} disablePadding>
                            <ListItemButton href={index === 1 ? '/characters' : index === 2 ? '/locations' : index === 3 ? '/episodes' : '/'} >
                                <ListItemIcon>
                                    {index === 0 ? <HomeIcon /> : index === 1 ? <PermIdentityIcon /> : index === 2 ? <LocationOnIcon /> : index === 3 ? <LiveTvIcon /> : ''}
                                </ListItemIcon>
